...
class VocsyReaderPage extends StatefulWidget {
  const VocsyReaderPage({super.key});

  @override
  State<VocsyReaderPage> createState() => _VocsyReaderPageState();
}

class _VocsyReaderPageState extends State<VocsyReaderPage> {
  bool loading = false;
  Dio dio = Dio();
  String filePath = "";
